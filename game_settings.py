...
TETROMINO_QUEUE_SURFACE_POS = vector(((WINDOW_WIDTH - TETRIS_WIDTH) // 2) + TETRIS_WIDTH + 20, (WINDOW_HEIGHT - TETRIS_HEIGHT) // 2)
DRAW_SCORE_POS = vector(((WINDOW_WIDTH - TETRIS_WIDTH) // 2) + TETRIS_WIDTH + 40, ((WINDOW_HEIGHT - TETRIS_HEIGHT) // 2) + TETROMINO_QUEUE_HEIGHT + 50)
DRAW_NEXT_LEVEL_POS = vector(((WINDOW_WIDTH - TETRIS_WIDTH) // 2) + TETRIS_WIDTH + 40, ((WINDOW_HEIGHT - TETRIS_HEIGHT) // 2) + TETROMINO_QUEUE_HEIGHT + 275)
DRAW_LEVEL_POS = vector(((WINDOW_WIDTH - TETRIS_WIDTH) // 2) - 215, ((WINDOW_HEIGHT - TETRIS_HEIGHT) // 2) + TETROMINO_QUEUE_HEIGHT + 50)
DRAW_SPEED_POS = vector(((WINDOW_WIDTH - TETRIS_WIDTH) // 2) - 215, ((WINDOW_HEIGHT - TETRIS_HEIGHT) // 2) + TETROMINO_QUEUE_HEIGHT + 275)
